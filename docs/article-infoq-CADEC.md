...
**Pushpdeep Mishra** is a Senior Manager at IIT Bombay, leading national-level initiatives in EdTech, innovation, healthcare and governance with central ministries, multiple state governments and multilateral partners. Pushpdeep brings together leadership, technical expertise, managerial capability and community engagement, and specialises in reducing redundancy and toil to increase efficiency for a given task. Pushpdeep values strong work ethics, fosters a culture of continuous learning within the team, and is passionate about emerging technologies, leadership practices, software and hardware product development, and AI-led digital transformation.
