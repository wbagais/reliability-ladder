...
- [[r5]], which runs last, is where a rung 1 verdict finally costs coverage.
...
| Verdict | `r1.apply` writes | `zone` after rung 1 | What [[r5]] does with it |
|---|---|---|---|
...
OUTPUT (rung 5)   zone = 'VERIFIED',  sct = '267036007' kept,  no withheld
```
...
- [[r2]] fires only on `REJECT`, stating `r1_reason` as fact.
- [[r5]] reads `r1_verdict`, falling back to the zone.
...
- [[r5]] · [[record]] · [[vocabulary]] · [[measurement]] · [[testing]] · [[glossary]]
